...
export class ImprovisedSpellDialogue extends FormApplication  {
   ...
   */
	static get defaultOptions() {
	  return mergeObject(super.defaultOptions, {
  	  ...
  	  template: "systems/WoD20/templates/dialogues/dialogue-improvisedSpell.html",
      resizable: true
    });
  }
  ...
  async _castSpell(spell){
    ...
    if(!spell.img || spell.img === "icons/svg/item-bag.svg" || spell.img.startsWith('systems/WoD20/icons/placeholders')) {
